...
public class ClasstitleActivity extends BaseActivity {
    ...
    // 读取课程章节名
    private String URL = "http://120.25.93.124:8080/YDKT/readClassTitle";
    // 添加我的课程
    private String URL_ADD_MYCLASS = "http://120.25.93.124:8080/YDKT/saveMyProject";
    // 科目对应图片所在位置的网络请求地址
    private String IMG_URL = "http://120.25.93.124:8080/YDKT/img/";
    // 是否已经添加到我的课程的识别码
