...
public class ClassContentActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private String UPDATE_PROGRESS_URL = "http://120.25.93.124:8080/YDKT/updateProg";
    ...
    // 服务器请求地址
    private String URL = "http://120.25.93.124:8080/YDKT/readClassContent";
    // 图片所在位置的网络请求地址
    private String IMG_URL = "http://120.25.93.124:8080/YDKT/img/img_proj/";
