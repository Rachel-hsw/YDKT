...
public class PostForumActivity extends BaseActivity {
    ...
    // 发送帖子的网络请求地址
    private String URL = "http://120.25.93.124:8080/YDKT/insertForumList";
    private String URL_PIC = "http://120.25.93.124:8080/YDKT/insertForumListpic";
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SUCCESS_TEXT:
                    Toast.makeText(PostForumActivity.this, "发送成功", Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                case FAILED_TEXT:
                    Toast.makeText(PostForumActivity.this, "发送失败", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
