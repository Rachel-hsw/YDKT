...
public class MyForumActivity extends BaseActivity {
    ...
    // 论坛列表的服务器请求地址
    private String URL = "http://120.25.93.124:8080/YDKT/readMyForum";
    // 从我的收藏中取消
    private static final String DELETE_URL = "http://120.25.93.124:8080/YDKT/deleteMyForum";
    /* private String URL = "http://192.168.1.101:8080/YDKT/readForumList";*/
    //http://192.168.1.101:8080/YDKT/readMyForum?user_id=3
    // 图片所在位置的网络请求地址
    private String IMG_URL = "http://120.25.93.124:8080/YDKT/";
